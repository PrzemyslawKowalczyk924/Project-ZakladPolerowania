export function resizerOfWidth() {
    ...
    const mobileLayout = window.matchMedia("(min-width: 319px) and (max-width: 425px)");
    
    const orginalContent = aboutWrapper.parentNode;
    const copyParent = aboutWrapper.parentNode;
    console.log(orginalContent);
    ...
    mobileLayout.addEventListener('change', function() {
        ...
        "</div>" 
            ...
            console.log(orginalContent)
            const morfeusz = orginalContent.appendChild(copyParent.childNodes)
            console.log(morfeusz)
        }
    });
